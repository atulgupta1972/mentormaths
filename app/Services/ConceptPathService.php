...
PROMPT;
    ...
    public function defaultTurnClockCard(int $step = 1): array
    {
        return [
            'step' => $step,
            'type' => 'turn_clock',
            'title' => 'Rotate the hand — turns ↔ angles',
            'body' => 'Same clock stays on screen. Rotate the minute hand to show 1/4, 1/2, 3/4, or a full turn. Then connect each turn to its angle (and the reverse).',
